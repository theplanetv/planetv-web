...
func (s *BlogTagFileService) Create(input *BlogTagFile) error {
	// Execute SQL
...
func (s *BlogTagFileService) Update(input *BlogTagFile) error {
	// Execute SQL
...
func (s *BlogTagFileService) GetFirst() (BlogTagFile, error) {
	// Execute SQL
	item := BlogTagFile{}
...
func (s *BlogTagFileService) GetLast() (BlogTagFile, error) {
	// Execute SQL
	item := BlogTagFile{}
	sql := "SELECT btf.id, btf.blogtag_id, btf.blogfile_id, bt.name, bf.filename FROM blogtagfile btf " +
...
func (s *BlogTagFileService) GetAll(limit *int, page *int) ([]BlogTagFile, error) {
	// Execute SQL
