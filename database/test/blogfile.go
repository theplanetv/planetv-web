...
func (s *BlogFileService) Create(input *BlogFile) error {
	// Execute SQL
...
func (s *BlogFileService) Update(input *BlogFile) error {
	// Execute SQL
...
func (s *BlogFileService) GetFirst() (BlogFile, error) {
	// Execute SQL
	item := BlogFile{}
...
func (s *BlogFileService) GetLast() (BlogFile, error) {
	// Execute SQL
	item := BlogFile{}
...
func (s *BlogFileService) GetAll(limit *int, page *int) ([]BlogFile, error) {
	// Execute SQL
