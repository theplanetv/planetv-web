...
func (s *BlogTagService) Create(input *BlogTag) error {
	// Execute SQL
...
func (s *BlogTagService) Update(input *BlogTag) error {
	// Execute SQL
...
func (s *BlogTagService) GetFirst() (BlogTag, error) {
	// Execute SQL
	item := BlogTag{}
...
func (s *BlogTagService) GetLast() (BlogTag, error) {
	// Execute SQL
	item := BlogTag{}
...
func (s *BlogTagService) GetAll(limit *int, page *int) ([]BlogTag, error) {
	// Execute SQL
